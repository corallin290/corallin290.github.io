...
const DICT = {
  en: {
    ...
    'err.tree.noSuchDir': "tree: cannot access '{target}': No such directory",
    'err.cd.noSuchDir': 'cd: {target}: No such directory',
    'help.header': 'Available commands:',
    'help.touchHint': 'Tip: hover (or long-press on touchscreens) a command button for more info.',
    'cmd.help.description': 'List available commands',
    'cmd.ls.description': 'List directory contents',
    'cmd.tree.description': 'Print directory tree',
    ...
    'ui.tooltip.speedUp': 'Speed up long outputs',
  ...
  ja: {
    ...
    'err.tree.noSuchDir': "tree: '{target}' にアクセスできません: そのようなディレクトリはありません",
    'err.cd.noSuchDir': 'cd: {target}: そのようなディレクトリはありません',
    'help.header': '利用可能なコマンド:',
    'help.touchHint': 'ヒント: コマンドボタンにカーソルを合わせる（タッチスクリーンでは長押しする）と詳細が表示されます。',
    'cmd.help.description': 'コマンド一覧を表示',
    'cmd.ls.description': 'ディレクトリの内容を表示',
    'cmd.tree.description': 'ディレクトリツリーを表示',
  ...
  zh: {
    ...
    'err.tree.noSuchDir': "tree：無法存取 '{target}'：找不到目錄",
    'err.cd.noSuchDir': 'cd：{target}：找不到目錄',
    'help.header': '可用指令：',
    'help.touchHint': '提示：將游標停留在指令按鈕上（觸控螢幕請長按）即可查看更多資訊。',
    'cmd.help.description': '列出可用指令',
    'cmd.ls.description': '列出目錄內容',
    'cmd.tree.description': '列印目錄樹',
